    ...
    <div class="container" style="padding-top:150px;">
          ...
          require('config.php');
    			...
    			if(isset($_POST["submit"])){
					if(isset($_POST["voterName"]) && isset($_POST["voterEmail"]) && isset($_POST["voterID"]) && isset($_POST["selectedCandidate"]))
					{
						...
						$selectedCandidate= test_input($_POST["selectedCandidate"]);
					}
				}
				else
				{
       ...
       $DB_NAME="db_evoting";
        ...
        or die("Couldn't Connect to Database :");
				...
				$sql= "INSERT INTO db_evoting.tbl_users VALUES(null,'".$voterName."','".$voterEmail."','".$voterID."','".$selectedCandidate."');";
				...
				if(mysqli_query($conn, $sql)){
					...
					echo "<a href='logout.php' class='btn btn-primary'> <span class='glyphicon glyphicon-ok'></span> <strong> Finish</strong> </a>";
				}
				else
				{
